...
special_character_count_check = False
special_characters = ['!','@','#','$','%','^','*','()']
...
if le > 8 and le < 16:
  ...
  if special_character_count > 0 and special_character_count < 4:
    special_character_count_check = True


if check_num == True and check_upper == True and check_lower == True and check_special == True and length == True and special_character_count_check == True:
  print('This can be a password')
else:
  print('This cannot be a password')
"""
...
day = datetime.date(2020,2,5)

days = day.weekday()
yays = weekdays[days]

print('Your day is on a {}'.format(yays))
"""
